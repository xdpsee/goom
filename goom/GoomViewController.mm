...
- (void) loadNextBuffer
{
    ...
    __block void *pngDataThreaded = _screenBuffer;
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0),
                   ^{
                       ...
                       [mappedTextureThreaded copyFlatPixelsIntoBuffer:(uint32_t*)pngDataThreaded];
                       ...
                       cVImageBufferRef:(CVImageBufferRef)cVImageBufferRef
{
    ...
    uint32_t *baseAddress = (uint32_t *)CVPixelBufferGetBaseAddress(cVImageBufferRef);
